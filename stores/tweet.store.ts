...
export const useTweetStore = defineStore('tweet', {
            ...
            return [
                {
                    role: 'system',
                    content:
                        "Act as if you're a social media expert. Give me a 10 tweet thread about Useful websites for developers. The thread should be optimised for virality and contain hashtags and emoticons. Each tweet should have at least 250 characters and should not exceed 280 characters in length. Thread hook should be engaging. Each Tweet should be separated by 'END\n\n'."
                },
                {
                    role: 'assistant',
                    content:
    ...
    actions: {
        ...
        changeContentType (contentType: 'tweet' | 'thread' | 'bio') {
