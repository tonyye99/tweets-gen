...
<template>
  <div>
    <n-form
      ...
      :model="model.thread"
      :disabled="loading"
      :rules="tweetStore.validations.thread"
      :size="size"
      label-placement="top"
      class="mt-5"
    >
      <n-grid responsive="screen">
        ...
        <n-form-item-gi :span="24" label="Additional">
          ...
          <n-checkbox
            v-model:checked="model.thread.isHashTags"
        ...
        <n-form-item-gi :span="24" label="Only Hook">
          <n-switch
            v-model:value="model.thread.onlyHook"
